...
namespace Microsoft.Graph.PowerShell.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"MgSecurityAction_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateMgSecurityAction_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Graph.PowerShell.Runtime.IEventListener
    {
        ...
        private Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityAction _bodyParameter;

        /// <summary>securityAction</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "securityAction", ValueFromPipeline = true)]
        [Microsoft.Graph.PowerShell.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"securityAction",
        SerializedName = @"bodyParameter",
        PossibleTypes = new [] { typeof(Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityAction) })]
        public Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityAction BodyParameter { get => this._bodyParameter; set => this._bodyParameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SecurityUpdateSecurityActions(SecurityActionId, BodyParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SecurityActionId=SecurityActionId,body=BodyParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateMgSecurityAction_Update" /> cmdlet class.
        /// </summary>
        public UpdateMgSecurityAction_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<IOdataError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SecurityActionId=SecurityActionId, body=BodyParameter })
                {
