...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    public class PsHelpExampleInfo : IEquatable<PsHelpExampleInfo>
    {
    ...
    public class PsParameterHelpInfo
    {
