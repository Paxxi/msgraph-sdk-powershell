...
using static Microsoft.Graph.PowerShell.Runtime.PowerShell.MarkdownTypesExtensions;
using static Microsoft.Graph.PowerShell.Runtime.PowerShell.PsHelpOutputExtensions;

namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    public class MarkdownHelpInfo
    {
    ...
    public class MarkdownSyntaxHelpInfo
    {
    ...
    public class MarkdownExampleHelpInfo : IEquatable<MarkdownExampleHelpInfo>
    {
    ...
    public class MarkdownParameterHelpInfo
    {
    ...
    public static class MarkdownTypesExtensions
    {
