...
{
    public class HelpMetadataOutput
    {
...
";
    ...
    public class HelpExampleOutput : IEquatable<HelpExampleOutput>
    {
...
";
    ...
    public class HelpParameterOutput
    {
...
";
    ...
    public class ModulePageMetadataOutput
    {
...
";
    ...
    public class ModulePageCmdletOutput
    {
        public MarkdownHelpInfo HelpInfo { get; }
...
";
    ...
    public static class PsHelpOutputExtensions
    {
