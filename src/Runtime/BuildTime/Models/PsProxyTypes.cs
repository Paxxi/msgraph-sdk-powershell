...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    public class VariantGroup
    {
        ...
        public VariantGroup(string moduleName, string cmdletName, Variant[] variants, string outputFolder, string profileName = NoProfiles, bool isTest = false, bool ispublic = false)
        {
    ...
    public class Variant
    {
        ...
        public Variant(string cmdletName, string variantName, CommandInfo info, CommandMetadata metadata, bool hasParameterSets = false, PsHelpInfo helpInfo = null)
        {
            ...
            Ispublic = Attributes.OfType<publicExportAttribute>().Any();
    ...
    public class Parameter
    {
        ...
        public Parameter(string variantName, string parameterName, ParameterMetadata metadata, PsParameterHelpInfo helpInfo = null)
        {
            ...
            Position = ParameterAttribute.Position == int.MinValue ? (int?)null : ParameterAttribute.Position;
    ...
    public class ComplexInterfaceInfo
    {
        public InfoAttribute InfoAttribute { get; }
    ...
    public static class PsProxyTypeExtensions
    {
