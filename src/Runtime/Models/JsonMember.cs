...
namespace Microsoft.Graph.PowerShell.Runtime.Json
{
    ...
    public sealed class JsonMember
    {
        ...
        public JsonMember(PropertyInfo property, int defaultOrder)
        {
            ...
            type = TypeDetails.Get(property.PropertyType);
        ...
        public JsonMember(FieldInfo field, int defaultOrder)
        {
            ...
            type = TypeDetails.Get(field.FieldType);
        ...
        public TypeDetails TypeDetails => type;
        ...
        public IJsonConverter Converter => type.JsonConverter;
