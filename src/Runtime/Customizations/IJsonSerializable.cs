...
namespace Microsoft.Graph.PowerShell.Runtime
{
    ...
    public static class JsonSerializable
    {
        ...
        {
            // numeric type
            if (vValue is sbyte || vValue is short || vValue is int || vValue is long || vValue is byte || vValue is ushort || vValue is uint || vValue is ulong || vValue is decimal || vValue is float || vValue is double)
            {
        ...
        public static JsonObject ToJson<T>(System.Collections.Generic.Dictionary<string, T> dictionary, JsonObject container) => ToJson((System.Collections.Generic.IDictionary<string, T>)dictionary, container);
        ...
        public static JsonObject ToJson<T>(System.Collections.Generic.IDictionary<string, T> dictionary, JsonObject container)
        {
        ...
        public static Func<JsonObject, System.Collections.Generic.IDictionary<string, V>> DeserializeDictionary<V>(Func<System.Collections.Generic.IDictionary<string, V>> dictionaryFactory)
        {
            return (node) => FromJson(node, dictionaryFactory(), (object)(DeserializeDictionary(dictionaryFactory)) as Func<JsonObject, V>);
        }

        public static System.Collections.Generic.IDictionary<string, V> FromJson<V>(JsonObject json, System.Collections.Generic.Dictionary<string, V> container, Func<JsonObject, V> objectFactory, System.Collections.Generic.HashSet<string> excludes = null) => FromJson(json, (System.Collections.Generic.IDictionary<string, V>)container, objectFactory, excludes);


        public static System.Collections.Generic.IDictionary<string, V> FromJson<V>(JsonObject json, System.Collections.Generic.IDictionary<string, V> container, Func<JsonObject, V> objectFactory, System.Collections.Generic.HashSet<string> excludes = null)
        {

         if (excludes != null){ excludes = new System.Collections.Generic.HashSet<string>(excludes, StringComparer.OrdinalIgnoreCase);}
            if (null == json)
            {
                return container;
            }
