...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    {
        SendAsyncStep Wrap(SendAsyncStep func);
        System.Collections.Generic.IEnumerable<SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<SendAsyncStep> funcs);

        T ExecuteSync<T>(System.Func<T> step);
    }

    public class AsyncCommandRuntime : ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        {
            originalCommandRuntime = cmdlet.CommandRuntime as ICommandRuntime2;
        ...
        public void Wait(System.Threading.Tasks.Task ProcessRecordAsyncTask, CancellationToken cancellationToken)
        {
            do
            {
        ...
        public SendAsyncStep Wrap(SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<SendAsyncStep> funcs) => funcs?.Select(Wrap);
        ...
        public void Dispose()
        {
            if (cmdlet != null)
            {
                cmdlet.CommandRuntime = originalCommandRuntime;
                cmdlet = null;
            }
