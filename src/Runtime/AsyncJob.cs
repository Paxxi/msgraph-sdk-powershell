...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    public class AsyncJob : Job, ICommandRuntime2
    {
        ...
        private bool IsJobDone => CancellationToken.IsCancellationRequested || JobStateInfo.State == JobState.Failed || JobStateInfo.State == JobState.Stopped || JobStateInfo.State == JobState.Stopping || JobStateInfo.State == JobState.Completed;
