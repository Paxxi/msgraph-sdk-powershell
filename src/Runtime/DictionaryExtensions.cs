...
namespace Microsoft.Graph.PowerShell.Runtime
{
    ...
    {
        public static void HashTableToDictionary<V>(System.Collections.Hashtable hashtable, System.Collections.Generic.IDictionary<string, V> dictionary)
        {
            foreach (var each in hashtable.Keys)
            {
                ...
                if (null != value)
                {
                    ...
                    {
                        HashTableToDictionary(nested, new System.Collections.Generic.Dictionary<string, V>());
                    }
                    else
                    {
                        try
