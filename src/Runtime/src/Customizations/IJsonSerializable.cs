...
namespace Microsoft.Graph.PowerShell.Runtime
{
    ...
    public static class JsonSerializable
    {
        ...
        public static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Graph.PowerShell.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Graph.PowerShell.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
        ...
        public static System.Collections.Generic.IDictionary<string, V> FromJson<V>(JsonObject json, System.Collections.Generic.Dictionary<string, V> container, System.Func<JsonObject, V> objectFactory, System.Collections.Generic.HashSet<string> excludes = null) => FromJson(json, (System.Collections.Generic.IDictionary<string, V>)container, objectFactory, excludes);


        public static System.Collections.Generic.IDictionary<string, V> FromJson<V>(JsonObject json, System.Collections.Generic.IDictionary<string, V> container, System.Func<JsonObject, V> objectFactory, System.Collections.Generic.HashSet<string> excludes = null)
        {

         if (excludes != null){ excludes = new System.Collections.Generic.HashSet<string>(excludes, global::System.StringComparer.OrdinalIgnoreCase);}
            if (null == json)
            {
                return container;
            }
