...
namespace Microsoft.Graph.PowerShell.Runtime.Json
{
    ...
    {
        public override object ToValue() => Microsoft.Graph.PowerShell.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
