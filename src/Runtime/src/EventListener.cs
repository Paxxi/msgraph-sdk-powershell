...
namespace Microsoft.Graph.PowerShell.Runtime
{
    ...
    {
        Task Validate(Microsoft.Graph.PowerShell.Runtime.IEventListener listener);
    }
    ...
    public static partial class Extensions
    {
        ...
        public static async Task AssertNotNull(this IEventListener instance, string parameterName, object value)
        {
            if (value == null)
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' should not be null", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertMinimumLength(this IEventListener instance, string parameterName, string value, int length)
        {
            ...
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Length of '{parameterName}' is less than {length}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertMaximumLength(this IEventListener instance, string parameterName, string value, int length)
        {
            if (value != null && value.Length > length)
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Length of '{parameterName}' is greater than {length}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        ...
        public static async Task AssertRegEx(this IEventListener instance, string parameterName, string value, string regularExpression)
        {
            ...
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' does not validate against pattern /{regularExpression}/", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertEnum(this IEventListener instance, string parameterName, string value, params string[] values)
        {
            ...
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' is not one of ({values.Aggregate((c, e) => $"'{e}',{c}")}", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertObjectIsValid(this IEventListener instance, string parameterName, object inst)
        {
            await (inst as Microsoft.Graph.PowerShell.Runtime.IValidates)?.Validate(instance);
        }
        ...
        public static async Task AssertIsLessThan<T>(this IEventListener instance, string parameterName, T? value, T max) where T : struct, System.IComparable<T>
        {
            ...
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be less than {max} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertIsGreaterThan<T>(this IEventListener instance, string parameterName, T? value, T max) where T : struct, System.IComparable<T>
        {
            if (null != value && ((T)value).CompareTo(max) <= 0)
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be greater than {max} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertIsLessThanOrEqual<T>(this IEventListener instance, string parameterName, T? value, T max) where T : struct, System.IComparable<T>
        {
            if (null != value && ((T)value).CompareTo(max) > 0)
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be less than or equal to {max} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertIsGreaterThanOrEqual<T>(this IEventListener instance, string parameterName, T? value, T max) where T : struct, System.IComparable<T>
        {
            if (null != value && ((T)value).CompareTo(max) < 0)
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be greater than or equal to {max} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        public static async Task AssertIsMultipleOf(this IEventListener instance, string parameterName, Int64? value, Int64 multiple)
        {
            ...
            {
                await instance.Signal(Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Graph.PowerShell.Runtime.Events.ValidationWarning, Message = $"Value of '{parameterName}' must be multiple of {multiple} (value is {value})", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
