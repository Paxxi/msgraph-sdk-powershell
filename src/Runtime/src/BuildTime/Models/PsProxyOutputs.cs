...
using static Microsoft.Graph.PowerShell.Runtime.PowerShell.PsProxyOutputExtensions;
using static Microsoft.Graph.PowerShell.Runtime.PowerShell.PsProxyTypeExtensions;

namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    public class OutputTypeOutput
    {
    ...
    public class CmdletBindingOutput
    {
    ...
    public class ValidateNotNullOutput
    {
    ...
    public class ArgumentCompleterOutput
    {
    ...
    public class DefaultInfoOutput
    {
    ...
    public class ParameterTypeOutput
    {
    ...
    public class ParameterNameOutput
    {
...
";
    ...
    public class HelpCommentOutput
    {
...
";
    ...
    public class ParameterDescriptionOutput
    {
    ...
    public class ParameterCategoryOutput
    {
    ...
    public class PropertySyntaxOutput
    {
        public string ParameterName { get; }
        public Type ParameterType { get; }
    ...
    public static class PsProxyOutputExtensions
    {
