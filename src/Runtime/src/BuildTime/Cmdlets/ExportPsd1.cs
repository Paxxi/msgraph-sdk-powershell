...
using static Microsoft.Graph.PowerShell.Runtime.PowerShell.PsHelpers;
  ...
  public class ExportPsd1 : PSCmdlet
  {
    ...
    protected override void ProcessRecord()
    {
      try
      {
        ...
        string version = Convert.ToString(@"1.7.0");
        ...
        sb.AppendLine($@"{Indent}RootModule = '{"./Microsoft.Graph.Applications.psm1"}'");
        ...
        sb.AppendLine($@"{Indent}Description = '{"Microsoft Graph PowerShell Cmdlets"}'");
        sb.AppendLine($@"{Indent}PowerShellVersion = '5.1'");
        sb.AppendLine($@"{Indent}DotNetFrameworkVersion = '4.7.2'");
        sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Microsoft.Graph.Applications.private.dll"}'");
        ...
        var formatList = customFormatPs1xmlFiles.Prepend("./Microsoft.Graph.Applications.format.ps1xml").ToPsList();
        ...
        sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Microsoft Office365 Graph PowerShell".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
        sb.AppendLine($@"{Indent}{Indent}{Indent}LicenseUri = '{"https://aka.ms/devservicesagreement"}'");
        sb.AppendLine($@"{Indent}{Indent}{Indent}ProjectUri = '{"https://github.com/microsoftgraph/msgraph-sdk-powershell"}'");
        sb.AppendLine($@"{Indent}{Indent}{Indent}ReleaseNotes = ''");
        var profilesList = "'v1.0-beta', 'v1.0'";
