...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        public AsyncOperationResponse(Microsoft.Graph.PowerShell.Runtime.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<Microsoft.Graph.PowerShell.Runtime.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(Microsoft.Graph.PowerShell.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Graph.PowerShell.Runtime.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(Microsoft.Graph.PowerShell.Runtime.Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && Microsoft.Graph.PowerShell.Runtime.Json.JsonNode.Parse(text).Type == Microsoft.Graph.PowerShell.Runtime.Json.JsonType.Object;
            }
            catch
            {
