...
namespace Microsoft.Graph.PowerShell.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        public AsyncOperationResponse(Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(Json.JsonNode node)
        {
            return node is Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="object"/> to convert from</param>
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="object" /> instance to check if it can be converted to the <see cref="AsyncOperationResponse"
        /// /> type.</param>
        /// <returns>
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            System.Type type = sourceValue.GetType();
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && Json.JsonNode.Parse(text).Type == Json.JsonType.Object;
            }
            catch
            {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            if (typeof(System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return new AsyncOperationResponse { Target = (sourceValue as System.Management.Automation.PSObject).GetValueForProperty("target", "", System.Convert.ToString) };
            }
            if (typeof(System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return new AsyncOperationResponse { Target = (sourceValue as System.Collections.IDictionary).GetValueForProperty("target", "", System.Convert.ToString) };
            }
            return null;
        }
