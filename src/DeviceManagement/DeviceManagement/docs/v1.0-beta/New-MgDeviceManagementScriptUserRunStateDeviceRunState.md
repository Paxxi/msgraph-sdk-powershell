...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementscriptuserrunstatedevicerunstate
schema: 2.0.0
---
...
```
New-MgDeviceManagementScriptUserRunStateDeviceRunState -DeviceManagementScriptId <String>
 -DeviceManagementScriptUserStateId <String> [-AdditionalProperties <Hashtable>] [-ErrorCode <Int32>]
 [-ErrorDescription <String>] [-Id <String>] [-LastStateUpdateDateTime <DateTime>]
 [-ManagedDevice <IMicrosoftGraphManagedDevice>] [-ResultMessage <String>] [-RunState <String>] [-Confirm]
...
```
New-MgDeviceManagementScriptUserRunStateDeviceRunState -DeviceManagementScriptId <String>
 -DeviceManagementScriptUserStateId <String> -BodyParameter <IMicrosoftGraphDeviceManagementScriptDeviceState>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDeviceManagementScriptUserRunStateDeviceRunState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptDeviceState> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgDeviceManagementScriptUserRunStateDeviceRunState -InputObject <IDeviceManagementIdentity>
 ...
 [-ResultMessage <String>] [-RunState <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphDeviceManagementScriptDeviceState
