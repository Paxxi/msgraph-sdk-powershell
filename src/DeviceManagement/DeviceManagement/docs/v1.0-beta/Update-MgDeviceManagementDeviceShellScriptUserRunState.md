...
Update-MgDeviceManagementDeviceShellScriptUserRunState -DeviceManagementScriptUserStateId <String>
 ...
 [-Id <String>] [-SuccessDeviceCount <Int32>] [-UserPrincipalName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementDeviceShellScriptUserRunState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptUserState> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphDeviceManagementScriptUserState
