...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementdeviceshellscriptdevicerunstate
schema: 2.0.0
---
...
```
Update-MgDeviceManagementDeviceShellScriptDeviceRunState -DeviceManagementScriptDeviceStateId <String>
 ...
 [-ManagedDevice <IMicrosoftGraphManagedDevice>] [-ResultMessage <String>] [-RunState <String>] [-PassThru]
...
### UpdateViaIdentity
```
Update-MgDeviceManagementDeviceShellScriptDeviceRunState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptDeviceState> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementDeviceShellScriptDeviceRunState -InputObject <IDeviceManagementIdentity>
 ...
 [-ResultMessage <String>] [-RunState <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
