...
New-MgDeviceManagementDeviceHealthScriptDeviceRunState -DeviceHealthScriptId <String>
 ...
 [-RemediationScriptError <String>] [-RemediationState <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgDeviceManagementDeviceHealthScriptDeviceRunState -DeviceHealthScriptId <String>
 -BodyParameter <IMicrosoftGraphDeviceHealthScriptDeviceState> [-Confirm] [-WhatIf] [<CommonParameters>]
```
