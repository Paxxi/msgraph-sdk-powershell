...
Update-MgDeviceManagementDeviceHealthScriptDeviceRunState -DeviceHealthScriptDeviceStateId <String>
 ...
 [-RemediationState <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgDeviceManagementDeviceHealthScriptDeviceRunState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceHealthScriptDeviceState> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementDeviceHealthScriptDeviceRunState -InputObject <IDeviceManagementIdentity>
 ...
 [-RemediationScriptError <String>] [-RemediationState <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
BODYPARAMETER <IMicrosoftGraphDeviceHealthScriptDeviceState>: Contains properties for device run state of the device health script.
