...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementdeviceshellscriptdevicerunstate
schema: 2.0.0
---
...
```
New-MgDeviceManagementDeviceShellScriptDeviceRunState -DeviceShellScriptId <String>
...
### CreateViaIdentity
```
New-MgDeviceManagementDeviceShellScriptDeviceRunState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptDeviceState> [-Confirm] [-WhatIf] [<CommonParameters>]
```
