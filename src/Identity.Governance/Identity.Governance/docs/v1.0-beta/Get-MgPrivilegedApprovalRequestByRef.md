...
### Get (Default)
```
Get-MgPrivilegedApprovalRequestByRef -PrivilegedApprovalId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrivilegedApprovalRequestByRef -InputObject <IIdentityGovernanceIdentity> [<CommonParameters>]
```
