...
### -ExternalId
The external id of the resource, representing its original id in the external system.
...
### -RegisteredRoot
The externalId of the resource's root scope that is registered in PIM.
