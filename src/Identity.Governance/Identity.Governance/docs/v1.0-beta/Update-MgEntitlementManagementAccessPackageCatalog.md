...
```
Update-MgEntitlementManagementAccessPackageCatalog -AccessPackageCatalogId <String>
 -BodyParameter <IMicrosoftGraphAccessPackageCatalog> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
  ...
  - `[IncompatibleGroups <IMicrosoftGraphGroup[]>]`: The groups whose members are ineligible to be assigned this access package.
    ...
    - `[Drive <IMicrosoftGraphDrive>]`: drive
      ...
      - `[CreatedByUser <IMicrosoftGraphUser>]`: Represents an Azure Active Directory user object.
        ...
        - `[PendingAccessReviewInstances <IMicrosoftGraphAccessReviewInstance1[]>]`: Navigation property to get list of access reviews pending approval by reviewer.
          - `[Id <String>]`: Read-only.
          ...
          - `[FallbackReviewers <IMicrosoftGraphAccessReviewReviewerScope1[]>]`: 
          - `[Reviewers <IMicrosoftGraphAccessReviewReviewerScope1[]>]`: 
          - `[Scope <IMicrosoftGraphAccessReviewScope>]`: accessReviewScope
