...
Update-MgEntitlementManagementAccessPackageAssignmentApproval -ApprovalId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-Stages <IMicrosoftGraphApprovalStage[]>] [-PassThru]
...
BODYPARAMETER <IMicrosoftGraphApproval>: approval
  ...
  - `[Id <String>]`: Read-only.
  - `[Stages <IMicrosoftGraphApprovalStage[]>]`: Used for the approvalStages property of approval settings in the requestApprovalSettings property of an access package assignment policy. Specifies the primary, fallback, and escalation approvers of each stage.
    - `[Id <String>]`: Read-only.
