...
### Get (Default)
```
Get-MgPolicyRoleManagementPolicyAssignmentPolicyByRef -UnifiedRoleManagementPolicyAssignmentId <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPolicyRoleManagementPolicyAssignmentPolicyByRef -InputObject <IIdentitySignInsIdentity>
 [<CommonParameters>]
```
