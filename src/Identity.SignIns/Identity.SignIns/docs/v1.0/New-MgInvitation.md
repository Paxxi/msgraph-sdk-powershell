...
```
New-MgInvitation [-AdditionalProperties <Hashtable>] [-Id <String>] [-InvitedUser <IMicrosoftGraphUser1>]
 ...
 [-InviteRedeemUrl <String>] [-InviteRedirectUrl <String>] [-SendInvitationMessage] [-Status <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgInvitation -BodyParameter <IMicrosoftGraphInvitation1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphInvitation1
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphInvitation1
...
BODYPARAMETER <IMicrosoftGraphInvitation1>: invitation
  ...
  - `[InvitedUser <IMicrosoftGraphUser1>]`: Represents an Azure Active Directory user object.
    - `[(Any) <Object>]`: This indicates any property can be added to this object.
