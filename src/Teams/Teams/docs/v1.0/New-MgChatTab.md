...
### Create
```
New-MgChatTab -ChatId <String> -BodyParameter <IMicrosoftGraphTeamsTab1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgChatTab -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsTab1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
