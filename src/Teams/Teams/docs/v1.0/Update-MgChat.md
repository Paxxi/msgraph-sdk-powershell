...
### Update1
```
Update-MgChat -ChatId <String> -BodyParameter <IMicrosoftGraphChat1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgChat -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChat1> [-PassThru] [-Confirm]
