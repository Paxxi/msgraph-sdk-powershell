...
### Create1
```
New-MgTeamChannel -TeamId <String> -BodyParameter <IMicrosoftGraphChannel1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
