...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mgteamchannel
schema: 2.0.0
---
...
New-MgTeamChannel -TeamId <String> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 ...
 [-ModerationSettings <IMicrosoftGraphChannelModerationSettings>] [-Tabs <IMicrosoftGraphTeamsTab[]>]
 [-WebUrl <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgTeamChannel -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgTeamChannel -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
To construct, see NOTES section for MODERATIONSETTINGS properties and create a hash table.

```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphChannelModerationSettings
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
