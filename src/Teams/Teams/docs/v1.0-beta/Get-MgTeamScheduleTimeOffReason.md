...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mgteamscheduletimeoffreason
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamScheduleTimeOffReason -TeamId <String> [-ExpandProperty <String[]>] [-Filter <String>]
