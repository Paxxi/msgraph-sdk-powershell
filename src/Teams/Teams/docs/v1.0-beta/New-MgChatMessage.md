...
### Create1
```
New-MgChatMessage -ChatId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgChatMessage -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage> [-Confirm]
