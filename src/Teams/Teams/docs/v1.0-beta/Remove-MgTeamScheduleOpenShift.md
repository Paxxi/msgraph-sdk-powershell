...
### Delete (Default)
```
Remove-MgTeamScheduleOpenShift -OpenShiftId <String> -TeamId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamScheduleOpenShift -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
