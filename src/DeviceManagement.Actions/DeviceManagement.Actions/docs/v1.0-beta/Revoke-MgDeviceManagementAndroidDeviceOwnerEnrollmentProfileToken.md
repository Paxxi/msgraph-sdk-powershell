...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/revoke-mgdevicemanagementandroiddeviceownerenrollmentprofiletoken
schema: 2.0.0
---
...
```
Revoke-MgDeviceManagementAndroidDeviceOwnerEnrollmentProfileToken
 -AndroidDeviceOwnerEnrollmentProfileId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
