...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths7Mtw3WDevicemanagementReportsMicrosoftGraphGetconfigurationpolicysettingsdevicesummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
