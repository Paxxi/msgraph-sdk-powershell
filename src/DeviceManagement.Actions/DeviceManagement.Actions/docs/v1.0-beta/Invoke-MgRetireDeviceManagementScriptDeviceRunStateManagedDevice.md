...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/invoke-mgretiredevicemanagementscriptdevicerunstatemanageddevice
schema: 2.0.0
---
...
### Retire (Default)
```
Invoke-MgRetireDeviceManagementScriptDeviceRunStateManagedDevice -DeviceManagementScriptDeviceStateId <String>
