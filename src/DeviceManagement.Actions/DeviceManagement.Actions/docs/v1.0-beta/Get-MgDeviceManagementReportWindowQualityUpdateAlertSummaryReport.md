...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsNun7U7DevicemanagementReportsMicrosoftGraphGetwindowsqualityupdatealertsummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
