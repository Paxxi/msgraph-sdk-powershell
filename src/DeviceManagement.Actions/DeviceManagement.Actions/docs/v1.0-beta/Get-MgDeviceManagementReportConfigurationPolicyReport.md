...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/get-mgdevicemanagementreportconfigurationpolicyreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceManagementReportConfigurationPolicyReport -OutFile <String> [-AdditionalProperties <Hashtable>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsK1AqbDevicemanagementReportsMicrosoftGraphGetconfigurationpoliciesreportfordevicePostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
