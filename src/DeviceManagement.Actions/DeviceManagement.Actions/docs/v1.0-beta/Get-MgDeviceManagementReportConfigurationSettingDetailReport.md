...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Y2B1ItDevicemanagementReportsMicrosoftGraphGetconfigurationsettingdetailsreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
