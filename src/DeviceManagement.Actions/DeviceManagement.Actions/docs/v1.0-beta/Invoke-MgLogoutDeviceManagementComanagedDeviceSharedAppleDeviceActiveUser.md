...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/invoke-mglogoutdevicemanagementcomanageddevicesharedappledeviceactiveuser
schema: 2.0.0
---
...
### Logout (Default)
```
Invoke-MgLogoutDeviceManagementComanagedDeviceSharedAppleDeviceActiveUser -ManagedDeviceId <String>
