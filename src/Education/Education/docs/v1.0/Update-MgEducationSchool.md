...
Update-MgEducationSchool -EducationSchoolId <String> [-AdditionalProperties <Hashtable>]
 [-Address <IMicrosoftGraphPhysicalAddress1>] [-AdministrativeUnit <IMicrosoftGraphAdministrativeUnit>]
 ...
 [-Id <String>] [-LowestGrade <String>] [-Phone <String>] [-PrincipalEmail <String>] [-PrincipalName <String>]
 [-SchoolNumber <String>] [-Users <IMicrosoftGraphEducationUser1[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
