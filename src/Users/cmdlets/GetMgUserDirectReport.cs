...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListDirectReports=>GET:"/users/{user-id}/directReports"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReport", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserDirectReport : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/directReports" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/directReports"; }
