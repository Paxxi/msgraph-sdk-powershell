...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetTasks=>GET:"/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTodoListTask", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTodoListTask : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgTodoTask>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(TodoTaskId) || InputObject != null; }
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : TodoTaskId)}" : $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks"; }
