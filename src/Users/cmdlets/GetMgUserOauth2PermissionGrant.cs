...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListOauth2PermissionGrants=>GET:"/users/{user-id}/oauth2PermissionGrants"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOauth2PermissionGrant", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOauth2PermissionGrant : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOAuth2PermissionGrant>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/oauth2PermissionGrants" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/oauth2PermissionGrants"; }
