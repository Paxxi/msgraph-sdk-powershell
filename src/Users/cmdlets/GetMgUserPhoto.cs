...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetPhoto=>GET:"/users/{user-id}/photo"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserPhoto", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserPhoto : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgProfilePhoto>
    {
        ...
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of profilePhoto", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = InputObjectParameterSet, Mandatory = true, HelpMessage = "key: id of profilePhoto", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = ListParameterSet, Mandatory = true, HelpMessage = "key: id of profilePhoto", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = FilterParameterSet, Mandatory = true, HelpMessage = "key: id of profilePhoto", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = SearchParameterSet, Mandatory = true, HelpMessage = "key: id of profilePhoto", ValueFromPipeline = false)]
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/photo" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/photos"; }
