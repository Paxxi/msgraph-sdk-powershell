...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetMultiValueExtendedProperties=>GET:"/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskFolderMultiValueExtendedProperty", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskFolderMultiValueExtendedProperty : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgMultiValueLegacyExtendedProperty>
    {
