...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListTransitiveMemberOf=>GET:"/users/{user-id}/transitiveMemberOf"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOf", DefaultParameterSetName = ListParameterSet)]
    [Alias("Get-MgUserTransitiveMember")]
    public partial class GetMgUserTransitiveMemberOf : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/transitiveMemberOf" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/transitiveMemberOf"; }
