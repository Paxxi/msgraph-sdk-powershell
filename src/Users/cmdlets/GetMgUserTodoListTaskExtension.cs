...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetExtensions=>GET:"/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/extensions/{extension-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTodoListTaskExtension", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTodoListTaskExtension : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<string>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks/{Uri.EscapeDataString(TodoTaskId)}/extensions/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : ExtensionId)}" : $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks/{Uri.EscapeDataString(TodoTaskId)}/extensions"; }
