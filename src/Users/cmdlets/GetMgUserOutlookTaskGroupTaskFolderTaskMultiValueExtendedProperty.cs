...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetMultiValueExtendedProperties=>GET:"/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskGroupTaskFolderTaskMultiValueExtendedProperty", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskGroupTaskFolderTaskMultiValueExtendedProperty : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgMultiValueLegacyExtendedProperty>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(MultiValueLegacyExtendedPropertyId) || InputObject != null; }

        /// <summary>key: id of multiValueLegacyExtendedProperty</summary>
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of multiValueLegacyExtendedProperty", ValueFromPipeline = false)]
        public string MultiValueLegacyExtendedPropertyId { get; set; }
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups/{Uri.EscapeDataString(OutlookTaskGroupId)}/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/tasks/{Uri.EscapeDataString(OutlookTaskId)}/multiValueExtendedProperties/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : MultiValueLegacyExtendedPropertyId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups/{Uri.EscapeDataString(OutlookTaskGroupId)}/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/tasks/{Uri.EscapeDataString(OutlookTaskId)}/multiValueExtendedProperties"; }
