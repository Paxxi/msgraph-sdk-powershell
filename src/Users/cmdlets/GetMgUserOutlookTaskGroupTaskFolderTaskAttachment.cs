...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetAttachments=>GET:"/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}/attachments/{attachment-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskGroupTaskFolderTaskAttachment", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskGroupTaskFolderTaskAttachment : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgAttachment>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups/{Uri.EscapeDataString(OutlookTaskGroupId)}/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/tasks/{Uri.EscapeDataString(OutlookTaskId)}/attachments/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : AttachmentId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups/{Uri.EscapeDataString(OutlookTaskGroupId)}/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/tasks/{Uri.EscapeDataString(OutlookTaskId)}/attachments"; }
