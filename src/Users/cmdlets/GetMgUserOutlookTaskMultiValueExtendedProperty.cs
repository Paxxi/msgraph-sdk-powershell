...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetMultiValueExtendedProperties=>GET:"/users/{user-id}/outlook/tasks/{outlookTask-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskMultiValueExtendedProperty", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskMultiValueExtendedProperty : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgMultiValueLegacyExtendedProperty>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/tasks/{Uri.EscapeDataString(OutlookTaskId)}/multiValueExtendedProperties/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : MultiValueLegacyExtendedPropertyId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/tasks/{Uri.EscapeDataString(OutlookTaskId)}/multiValueExtendedProperties"; }
