...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetExtensions=>GET:"/users/{user-id}/todo/lists/{todoTaskList-id}/extensions/{extension-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTodoListExtension", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTodoListExtension : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<string>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/extensions/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : ExtensionId)}" : $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/extensions"; }
