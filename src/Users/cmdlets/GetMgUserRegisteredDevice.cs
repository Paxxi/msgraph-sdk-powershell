...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListRegisteredDevices=>GET:"/users/{user-id}/registeredDevices"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDevice", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserRegisteredDevice : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/registeredDevices" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/registeredDevices"; }
