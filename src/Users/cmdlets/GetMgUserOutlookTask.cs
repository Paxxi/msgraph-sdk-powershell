...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetTasks=>GET:"/users/{user-id}/outlook/tasks/{outlookTask-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTask", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTask : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOutlookTask>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/tasks/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : OutlookTaskId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/tasks"; }
