...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListOwnedObjects=>GET:"/users/{user-id}/ownedObjects"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObject", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOwnedObject : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/ownedObjects" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/ownedObjects"; }
