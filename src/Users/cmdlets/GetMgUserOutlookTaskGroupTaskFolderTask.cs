...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetTasks=>GET:"/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskGroupTaskFolderTask", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskGroupTaskFolderTask : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOutlookTask>
    {
