...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListCreatedObjects=>GET:"/users/{user-id}/createdObjects"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserCreatedObject", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserCreatedObject : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/createdObjects" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/createdObjects"; }
