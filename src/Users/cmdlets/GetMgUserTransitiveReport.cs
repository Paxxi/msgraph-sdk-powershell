...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListTransitiveReports=>GET:"/users/{user-id}/transitiveReports"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveReport", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTransitiveReport : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/transitiveReports" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/transitiveReports"; }
