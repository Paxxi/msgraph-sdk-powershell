...
namespace Cmdlets
{
    ...
    /// <summary>Get taskGroups from users</summary>
    /// <remarks>
    /// [OpenAPI] GetTaskGroups=>GET:"/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskGroup", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskGroup : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOutlookTaskGroup>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(OutlookTaskGroupId) || InputObject != null; }
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : OutlookTaskGroupId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskGroups"; }
