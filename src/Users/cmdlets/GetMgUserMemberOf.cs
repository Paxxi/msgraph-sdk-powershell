...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListMemberOf=>GET:"/users/{user-id}/memberOf"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOf", DefaultParameterSetName = ListParameterSet)]
    [Alias("Get-MgUserMember")]
    public partial class GetMgUserMemberOf : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/memberOf" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/memberOf"; }
