...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListOwnedDevices=>GET:"/users/{user-id}/ownedDevices"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDevice", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOwnedDevice : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgDirectoryObject>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/ownedDevices" : $"/users/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : UserId)}/ownedDevices"; }
