...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetLists=>GET:"/users/{user-id}/todo/lists/{todoTaskList-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTodoList", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTodoList : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgTodoTaskList>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(TodoTaskListId) || InputObject != null; }
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : TodoTaskListId)}" : $"/users/{Uri.EscapeDataString(UserId)}/todo/lists"; }
