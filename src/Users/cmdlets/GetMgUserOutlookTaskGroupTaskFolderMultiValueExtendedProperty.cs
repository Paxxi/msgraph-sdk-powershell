...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetMultiValueExtendedProperties=>GET:"/users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskGroupTaskFolderMultiValueExtendedProperty", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskGroupTaskFolderMultiValueExtendedProperty : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgMultiValueLegacyExtendedProperty>
    {
