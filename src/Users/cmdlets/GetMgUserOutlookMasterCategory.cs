...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetMasterCategories=>GET:"/users/{user-id}/outlook/masterCategories/{outlookCategory-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookMasterCategory", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookMasterCategory : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOutlookCategory>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(OutlookCategoryId) || InputObject != null; }

        /// <summary>key: id of outlookCategory</summary>
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of outlookCategory", ValueFromPipeline = false)]
        public string OutlookCategoryId { get; set; }
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/masterCategories/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : OutlookCategoryId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/masterCategories"; }
