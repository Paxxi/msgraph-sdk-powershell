...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetTaskFolders=>GET:"/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskFolder", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskFolder : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgOutlookTaskFolder>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskFolders/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : OutlookTaskFolderId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskFolders"; }
