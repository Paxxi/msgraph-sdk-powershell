...
namespace Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GetSingleValueExtendedProperties=>GET:"/users/{user-id}/outlook/taskFolders/{outlookTaskFolder-id}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookTaskFolderSingleValueExtendedProperty", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserOutlookTaskFolderSingleValueExtendedProperty : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgSingleValueLegacyExtendedProperty>
    {
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/singleValueExtendedProperties/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : SingleValueLegacyExtendedPropertyId)}" : $"/users/{Uri.EscapeDataString(UserId)}/outlook/taskFolders/{Uri.EscapeDataString(OutlookTaskFolderId)}/singleValueExtendedProperties"; }
