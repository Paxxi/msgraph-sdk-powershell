...
namespace Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GetLinkedResources=>GET:"/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/linkedResources/{linkedResource-id}"
    /// </remarks>
    [Cmdlet(VerbsCommon.Get, "MgUserTodoListTaskLinkedResource", DefaultParameterSetName = ListParameterSet)]
    public partial class GetMgUserTodoListTaskLinkedResource : Microsoft.Graph.PowerShell.Runtime.Cmdlets.GetCmdletBase<Microsoft.Graph.PowerShell.Users.Models.MgLinkedResource>
    {
        ...
        protected override bool IsSingle { get => !string.IsNullOrEmpty(LinkedResourceId) || InputObject != null; }

        /// <summary>key: id of linkedResource</summary>
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of linkedResource", ValueFromPipeline = false)]
        ...
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of todoTask", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = InputObjectParameterSet, Mandatory = true, HelpMessage = "key: id of todoTask", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = ListParameterSet, Mandatory = true, HelpMessage = "key: id of todoTask", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = FilterParameterSet, Mandatory = true, HelpMessage = "key: id of todoTask", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = SearchParameterSet, Mandatory = true, HelpMessage = "key: id of todoTask", ValueFromPipeline = false)]
        public string TodoTaskId { get; set; }

        /// <summary>key: id of todoTaskList</summary>
        [Parameter(ParameterSetName = IdParameterSet, Mandatory = true, HelpMessage = "key: id of todoTaskList", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = InputObjectParameterSet, Mandatory = true, HelpMessage = "key: id of todoTaskList", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = ListParameterSet, Mandatory = true, HelpMessage = "key: id of todoTaskList", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = FilterParameterSet, Mandatory = true, HelpMessage = "key: id of todoTaskList", ValueFromPipeline = false)]
        [Parameter(ParameterSetName = SearchParameterSet, Mandatory = true, HelpMessage = "key: id of todoTaskList", ValueFromPipeline = false)]
        ...
        protected override string Url { get => IsSingle ? $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks/{Uri.EscapeDataString(TodoTaskId)}/linkedResources/{Uri.EscapeDataString(InputObject != null ? InputObject.Id : LinkedResourceId)}" : $"/users/{Uri.EscapeDataString(UserId)}/todo/lists/{Uri.EscapeDataString(TodoTaskListId)}/tasks/{Uri.EscapeDataString(TodoTaskId)}/linkedResources"; }
